...
func syntax_filesXmlYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "syntax_files/xml.yaml", size: 280, mode: os.FileMode(420), modTime: time.Unix(1561458472, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
