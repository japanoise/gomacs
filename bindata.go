...
func syntax_filesViYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "syntax_files/vi.yaml", size: 720, mode: os.FileMode(420), modTime: time.Unix(1561458472, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
